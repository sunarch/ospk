...
function oberstufenpunktekalkulator() {
    ...
    /////*- Methods -*/////
        this.calculate = ospk_calculate;
        this.display = ospk_display;
        this.useOption = ospk_useOption;
        this.importData = ospk_importData;
        this.exportData = ospk_exportData;
        this.applyValuesToInputFields = ospk_applyValuesToInputFields;
        this.mark_results = ospk_mark_results;
    ...
    /////*- Method constructors -*/////
        ...
        function ospk_useOption(optionId,optionValue) {
        ...
        function ospk_importData(importText) {
        ...
        function ospk_applyValuesToInputFields() {
            if (this.student.zweig == "hu") {
        ...
        function ospk_setFluidOption(which,toWhat) {
            //"deWahlNatWis"
        }
        function ospk_mark_results() {
...
function bereichA() {
    ...
    /////*- Methods -*/////
        //this.method = bereichA_method;
        this.calculate = bereichA_calculate;

    }
    /////*- Method constructors -*/////
        //function bereichA_method() {}
        function bereichA_calculate() {
...
function bereichC() {
    ...
    /////*- Methods -*/////
        //this.method = bereichC_method;
        this.calculate = bereichC_calculate;

    }
    /////*- Method constructors -*/////
        //function bereichC_method() {}
        function bereichC_calculate() {
...
function bereichB() {
    ...
    /////*- Methods -*/////
        //this.method = bereichB_method;
        this.calculate = bereichB_calculate;
        this.reset = bereichB_reset;
        this.readValues = bereichB_readValues;
        this.geschichte = bereichB_geschichte;
        this.selectGrades = bereichB_selectGrades;

    }
    /////*- Method constructors -*/////
        //function bereichB_method() {}
        function bereichB_reset() {
            this.ergebnis = 0;
            this.fach4_3hj = 0;
            this.all = new Array();
            this.mat = new Array();
...
function student() {
    ...
    /////*- Methods -*/////
        this.set_zweig = student_set_zweig;
    }
    /////*- Method constructors -*/////
        function student_set_zweig(zweig) {
            if(cc.student.zweig == "") {
                cc.abiFach[1] = 1;
                switch(zweig) {
                    case "de":
...
function fach(name,fullNameDe,fullNameHu,type) {
    ...
    /////*- Methods -*/////
        //this.method = fach_method;

    }
    /////*- Method constructors -*/////
        //function fach_method() {}
...
function bb_halbjahr(fachname,halbjahrno,note) {
    ...
    /////*- Methods -*/////
        //this.method = bb_halbjahr_method;

    }
    /////*- Method constructors -*/////
        //function bb_halbjahr_method() {}
